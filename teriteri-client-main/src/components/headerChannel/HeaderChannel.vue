        ...
        <div class="right-channel-container">
            ...
            <div class="channel-items__left" v-if="channels.length != 0">
                ...
                <VPopover class="channel-link" placement="top" popStyle="z-index: 2000; cursor: default;">
                    <template #reference>
                        <div @click="goToCategory(`/v/${channels[0].mcId}`)">
                    ...
                    <template #content>
                        <div class="channel-children-container">
                            ...
                            >
                                <div @click="goToCategory(`/v/${child.mcId}/${child.scId}`)"
                ...
                <VPopover class="channel-link" placement="top" popStyle="z-index: 2000; cursor: default;">
                    <template #reference>
                        <div @click="goToCategory(`/v/${channels[1].mcId}`)">
                ...
                >
                    <template #reference>
                        <div @click="goToCategory(`/v/${item.mcId}`)">
                ...
                >
                    ...
                    <template #content>
                        <div class="more-channel-popover__wrap">
                            ...
                            <div class="more-channel"></div>
                            <!-- 前面的是占位符，反正也展示不出来的 -->
                            <div class="more-channel" v-for="(item, index) in channels.slice(2)" :key="index" @click="goToCategory(`/v/${item.mcId}`)">
                                {{ item.mcName }}
                            </div>
