...
public interface VideoService {
     ...
     * @return 视频信息列表
     */
    List<Map<String, Object>> getVideosByCategory(String mcId, String scId, Integer rule, Integer page, Integer quantity);
     ...
     * @return 视频总数
     */
    int getVideoCountByCategory(String mcId, String scId);
}
